...
// 편집 버튼은 헤더에 별도로 존재. 작업이 많아지면 줄바꿈.
  ...
  return (
    <div className="mt-3 flex items-center flex-wrap gap-y-1.5">
      {list.map((tk, idx) => {
        ...
        return (
          <div key={tk.id || idx} className="flex items-center">
            <button
